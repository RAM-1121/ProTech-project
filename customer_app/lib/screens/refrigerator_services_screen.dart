...
class RefrigeratorServicesScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Refrigerator Services'),
      ),
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: 8),
                        Text('Fast and reliable diagnostics and repair services.', style: TextStyle(fontSize: 14, color: AppColors.primaryMid)),
                      ],
                    ),
                  ),
                  SizedBox(width: 16),
                  Icon(Icons.kitchen, size: 48, color: AppColors.primaryMid),
                ],
              ),
            ),
            ...
            _buildServiceOption(context, 'Book A Complaint', 'Diagnostic & repair services', Icons.report_problem),
          ],
        ),
      ),
    );
