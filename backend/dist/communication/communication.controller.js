...
let CommunicationController = class CommunicationController {
    ...
    async getLiveKitToken(room, participant) {
...
__decorate([
    (0, common_1.Get)('livekit/token'),
    __param(0, (0, common_1.Query)('room')),
    __param(1, (0, common_1.Query)('participant')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String]),
    __metadata("design:returntype", Promise)
], CommunicationController.prototype, "getLiveKitToken", null);
